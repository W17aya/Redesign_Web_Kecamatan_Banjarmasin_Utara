          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Nikah</h3>
              </div>
                ...
                <tbody style="text-align: left; vertical-align: top;">
                  <?php
                    ...
                    if (isset($_POST['status'])) {
                      $status = $_POST['status'];
                      $data = mysqli_query($conn,"SELECT * FROM `tb_nikah` JOIN tb_penduduk ON tb_penduduk.id_penduduk=tb_nikah.id_penduduk JOIN tb_ttd ON tb_ttd.id_ttd=tb_nikah.id_ttd WHERE status='$status' ORDER BY tb_nikah.id_nikah DESC");
                    } else {
                      $data = mysqli_query($conn,"SELECT * FROM `tb_nikah` JOIN tb_penduduk ON tb_penduduk.id_penduduk=tb_nikah.id_penduduk JOIN tb_ttd ON tb_ttd.id_ttd=tb_nikah.id_ttd ORDER BY tb_nikah.id_nikah DESC");
                    };

                ...
                <tbody style="text-align: left; vertical-align: top;">
                  <?php
                    ...
                    if (isset($_POST['status'])) {
                      $status = $_POST['status'];
                      $data = mysqli_query($conn,"SELECT * FROM `tb_pindah` JOIN tb_penduduk ON tb_penduduk.id_penduduk=tb_pindah.id_penduduk JOIN tb_ttd ON tb_ttd.id_ttd=tb_pindah.id_ttd WHERE status='$status' ORDER BY tb_pindah.id_pindah DESC");
                    } else {
                      $data = mysqli_query($conn,"SELECT * FROM `tb_pindah` JOIN tb_penduduk ON tb_penduduk.id_penduduk=tb_pindah.id_penduduk JOIN tb_ttd ON tb_ttd.id_ttd=tb_pindah.id_ttd ORDER BY tb_pindah.id_pindah DESC");
                    };
                  ...
                  <tr>
                    ...
                    <td><?php echo $dataa['alamat_pindah'];?></td>
                    <td><?php echo $dataa['jumlah_pindah'];?></td>

              ...
              <div class="col-lg-12">
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h5 class="card-title" style="font-family: sans-serif;"><i class="fa fa-md fa-list fa-fw"></i> KEGIATAN</h5>
                  </div>
                  <div class="card-body">
                    <?php 
                      $no=1;
                      $id = $_GET['id'];
                      $data = mysqli_query($conn,"SELECT * FROM kegiatan WHERE kd_kegiatan='$id'");
                    ...
                    <div class="col-md-12">
                      <div class="card flex-md-row box-shadow h-md-250">
                        ...
                        <div class="card-body d-flex flex-column align-items-start">
                          ...
                          <p class="card-text mb-auto"><?= $dataa['isi_kegiatan'] ?></p>
                        </div>
                      </div>
                    </div>
                    <?php };?>
                  ...
                  <div class="card-footer">
                    <a href="kegiatan_lihat2.php" class="btn btn-primary btn-block btn-sm">Lihat Semua</a>
                  </div>
                </div>
              </div>
